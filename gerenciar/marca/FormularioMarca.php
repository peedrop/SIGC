...
?>
    ...
    <body class="skin-blue" onload="exibirRelogio()">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Formulário Marca</a></li>
                    </ol>
                </section>
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <form id="formMarca" action="MarcaControlador.php?operacao=salvar" method="post">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <label>Nome</label>
                                                <input type="hidden" name="idMarca" id="idMarca" value="<?php echo $marca->getIdMarca() ?>">
                                                <input type="text" class="form-control" id="nome" name="nome" value="<?php echo $marca->getNome() ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript" src="../../arquivos/js/marca.js"></script>
    </body>
