        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Tabela Marca</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><button type="button" class="btn btn-primary btn-lg btn-block" onclick="window.location.href='FormularioMarca.php';">Adicionar</button></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                ...
                                                foreach($lista as $marca){
                                                    ...
                                                    echo"<td class='btn-block'>
                                                        <a type='button' class='btn btn-success btn-sm' href='FormularioMarca.php?idMarca={$marca->getIdMarca()}'>editar</a>
                                                        <a type='button' class='btn btn-danger btn-sm' data-toggle='confirmation' data-placement='left' data-title='Deseja realmente excluir?' href='MarcaControlador.php?operacao=excluir&idMarca={$marca->getIdMarca()}'>excluir</a>
                                                        </td>";						
                                                    echo"</tr>";					
                                                }
					                       ?>
