...
?>
    ...
    <body class="skin-blue" onload="exibirRelogio()">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Pedidos por Cliente</a></li>
                    </ol>
                </section>
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <form id="formVendasPDF" action="RelatorioPedidoUsuarioImpressao.php" target="_blank" method="post">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        <button class="btn btn-success btn-block" type="submit" name="action">Gerar</button>
                                    </div>
                                    <div class="col-md-3">
        ...
        <script type="text/javascript" src="../../arquivos/js/vendasPDF.js"></script>
    </body>
