...
?>
    ...
    <body class="skin-blue" onload="exibirRelogio()">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Venda de Produtos</a></li>
                    </ol>
                </section>
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <form id="formVendaProd" action="RelatorioVendaProdutosPDF.php" target="_blank" method="post">
        ...
        <script type="text/javascript" src="../../arquivos/js/vendaProdutosPDF.js"></script>
    </body>
