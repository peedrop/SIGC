...
?>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Formulário Despesas</title>
    ...
    <body class="skin-blue" onload="exibirRelogio()">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Formulário Despesas</a></li>
                    </ol>
                </section>
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <form id="formDespesa" action="DespesaControlador.php?operacao=salvar" method="post">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <input type="text" class="form-control" id="nome" name="nome" value="<?php echo $despesa->getNome() ?>">
                                            </div>
                                            <div class="col-xs-12">
                                                <label>Descrição</label>
                                                <textarea type="text" class="form-control" id="descricao" name="descricao"> <?php echo $despesa->getDescricao() ?> </textarea>
                                            </div>
                                            <div class="col-xs-4">
                                                <label>Data Vencimento</label>
                                                <input type="date" class="form-control" id="dataVencimento" name="dataVencimento" value="<?php echo $despesa->getDataVencimento() ?>">
                                            </div>
                                            <div class="col-xs-4">
                                                <label>Valor</label>
                                                <div class="input-group"> <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                                                    <input type="text" name="valor" id="valor" class="form-control" placeholder="0,00" value="<?php echo $despesa->getValor() ?>">
                                                </div>
                                            </div>
                                            <div class="col-xs-4">
                                                <label class="teste control-label" for="radios">Situação </label>
                                                <div class='form-group'>

                                                    <label required='' class='radio-inline' for='situacaoPago'>
                                                    <input name='situacao' id='situacaoPago' value='1' type='radio' required <?php if ($despesa->getSituacao() == 1){ echo $sit; }?>>Pago </label>

                                                    <label class='radio-inline' for='situacaoPendente'>
                                                    <input name='situacao' id='situacaoPendente' value='2' type='radio' <?php if ($despesa->getSituacao() == 2){ echo $sit; }?>>Pendente</label>
        ...
        <script type="text/javascript" src="../../arquivos/js/despesa.js"></script>
    </body>
