        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Tabela Despesas</a></li>
                    </ol>
                </section>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-md-1"><button type="button" class="btn btn-primary btn-lg btn-block" onclick="window.location.href='FormularioDespesa.php';">Adicionar</button></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                ...
                                                foreach($lista as $despesa){
                                                    ...
                                                    $data = $despesa->getDataVencimento();
                                                    $dataP = explode('-', $data);
                                                    ...
                                                    echo"<td>R$ {$despesa->getValor()}</td>";
                                                    echo"<td>{$sis}</td>";
                                                    echo"<td class='btn-block'>
                                                        <a type='button' class='btn btn-success btn-sm' href='FormularioDespesa.php?idDespesa={$despesa->getIdDespesa()}'>editar</a>
                                                        <a type='button' class='btn btn-danger btn-sm' data-toggle='confirmation' data-placement='left' data-title='Deseja realmente excluir?' href='DespesaControlador.php?operacao=excluir&idDespesa={$despesa->getIdDespesa()}'>excluir</a>
                                                        </td>";						
                                                    echo"</tr>";					
                                                }
					                       ?>
