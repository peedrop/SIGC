...
?>
    ...
    <body class="skin-blue" onload="exibirRelogio()">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Formulário Tipo</a></li>
                    </ol>
                </section>
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            <form id="formTipo" action="TipoControlador.php?operacao=salvar" method="post">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <label>Nome</label>
                                                <input type="hidden" name="idTipo" id="idTipo" value="<?php echo $tipo->getIdTipo() ?>">
                                                <input type="text" class="form-control" id="nome" name="nome" value="<?php echo $tipo->getNome() ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript" src="../../arquivos/js/tipo.js"></script>
    </body>
