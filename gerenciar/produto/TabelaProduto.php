        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Tabela Produto</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-md-1">Estoque Mínimo</th>
                                                <th class="col-md-1">Quantidade</th>
                                                <th class="col-md-1">Valor</th>
                                                <th class="col-md-1"><button type="button" class="btn btn-primary btn-lg btn-block" onclick="window.location.href='FormularioProduto.php';">Adicionar</button></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                ...
                                                foreach($lista as $produto){
                                                    ...
                                                    $marca = $marcaDAO->buscarPorId($idMarca);
                                                    
                                                    echo"<tr>";			
                                                    echo"<td>{$produto->getNome()}</td>";
                                                    echo"<td>{$tipo->getNome()}</td>";
                                                    echo"<td>{$marca->getNome()}</td>";
                                                    ...
                                                    echo"<td class='btn-block'>
                                                        <a type='button' class='btn btn-success btn-sm' href='FormularioProduto.php?idProduto={$produto->getIdProduto()}'>editar</a>
                                                        <a type='button' class='btn btn-danger btn-sm' data-toggle='confirmation' data-placement='left' data-title='Deseja realmente excluir?' href='ProdutoControlador.php?operacao=excluir&idProduto={$produto->getIdProduto()}'>excluir</a>
                                                        </td>";						
                                                    echo"</tr>";					
                                                }
					                       ?>
