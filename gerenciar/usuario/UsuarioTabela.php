        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Tabela Usuários</a></li>
                    </ol>
                </section>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-md-1"><button type="button" class="btn btn-primary btn-lg btn-block" onclick="window.location.href='UsuarioFormulario.php';">Adicionar</button></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                                ...
                                                foreach($lista as $usuario){
                                                    ...
                                                    echo"<td class='btn-block'>
                                                        <a type='button' class='btn btn-success btn-sm' href='UsuarioFormulario.php?idUsuario={$usuario->getIdUsuario()}'>editar</a>
                                                        <a type='button' class='btn btn-danger btn-sm' data-toggle='confirmation' data-placement='left' data-title='Deseja realmente excluir?' href='UsuarioControlador.php?operacao=excluir&idUsuario={$usuario->getIdUsuario()}'>excluir</a>
                                                        </td>";						
                                                    echo"</tr>";					
                                                }
					                       ?>
